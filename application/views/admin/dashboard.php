...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/public/app-assets/css/themes/dark-layout.min.css">
    <link rel="stylesheet" type="text/css" href="/public/app-assets/css/themes/bordered-layout.min.css">
    <link rel="stylesheet" type="text/css" href="/public/app-assets/css/themes/semi-dark-layout.min.css">

    <!-- BEGIN: Page CSS-->
    <link rel="stylesheet" type="text/css" href="/public/app-assets/css/core/menu/menu-types/vertical-menu.min.css">
    <link rel="stylesheet" type="text/css" href="/public/app-assets/css/pages/dashboard-ecommerce.min.css">
    <link rel="stylesheet" type="text/css" href="/public/app-assets/css/plugins/charts/chart-apex.min.css">
    <link rel="stylesheet" type="text/css" href="/public/app-assets/css/plugins/extensions/ext-component-toastr.min.css">
    <!-- END: Page CSS-->
      ...
      <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ml-auto">
          ...
          <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John Doe</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="/public/app-assets/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span></a>
      ...
      <div class="card card-developer-meetup">
        ...
        <div class="card-body">
          ...
          <div class="avatar-group">
            ...
            >
              <img
                src="/public/app-assets/images/portrait/small/avatar-s-20.jpg"
                alt="Avatar"
                width="33"
                height="33"
              />
      ...
      <div class="card card-browser-states">
        ...
        <div class="card-body">
          <div class="browser-states">
            <div class="media">
              <img
                src="/public/app-assets/images/icons/google-chrome.png"
                class="rounded mr-1"
                height="30"
                alt="Google Chrome"
              />
          ...
          <div class="browser-states">
            <div class="media">
              <img
                src="/public/app-assets/images/icons/mozila-firefox.png"
                class="rounded mr-1"
                height="30"
                alt="Mozila Firefox"
              />
          ...
          <div class="browser-states">
            <div class="media">
              <img
                src="/public/app-assets/images/icons/apple-safari.png"
                class="rounded mr-1"
                height="30"
                alt="Apple Safari"
              />
          ...
          <div class="browser-states">
            <div class="media">
              <img
                src="/public/app-assets/images/icons/internet-explorer.png"
                class="rounded mr-1"
                height="30"
          ...
          <div class="browser-states">
            <div class="media">
              <img src="/public/app-assets/images/icons/opera.png" class="rounded mr-1" height="30" alt="Opera Mini" />
